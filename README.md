...
- [Video basics for hardware engineers](https://sistenix.com/video_basics.html) — pixels, YCbCr/chroma subsampling, video timing, pixel clocks, video↔AXI-Stream, CDC, and the PNG image harness
- [Video DMA: triple-buffering, genlock and temporal taps](https://sistenix.com/vdma.html) — single-stream VDMA, frame ownership, genlock, multi-tap temporal reads, throughput, and real-image squirrel round-trip
